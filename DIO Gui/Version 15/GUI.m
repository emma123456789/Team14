...
% Last Modified by GUIDE v2.5 20-Sep-2018 14:26:06
...
global poseSpeed;
global joggingSpeed;
global eeX eeY eeZ eeQ1 eeQ2 eeQ3 eeQ4;
global jaQ1 jaQ2 jaQ3 jaQ4 jaQ5 jaQ6;

poseMode = 1;
poseSpeed = 'Slow'; joggingSpeed = 'Slow';
eeX = 0; eeY = 0; eeZ = 0; eeQ1 = 0; eeQ2 = 0; eeQ3 = 0;
eeQ4 = 0; jaQ1 = 0; jaQ2 = 0; jaQ3 = 0; jaQ4 = 0; jaQ5 = 0; jaQ6 = 0;
...
% 
% 		% sguideet image handle
% 		hImage=image(zeros(1200,1600,3),'Parent',g_handles.TableCamera);
% 		hImage2=image(zeros(1200,1600,3),'Parent',g_handles.ConveyorCamera);
% 		preview(vid,hImage);
% 		preview(vid,hImage);
...
% 
% 			% sguideet image handle
% 			hImage=image(zeros(1200,1600,3),'Parent',handles.TableCamera);
% % 			hImage2=image(zeros(800,1280,3),'Parent',handles.ConveyorCamera);
% 			preview(vid,hImage);
% % 			preview(vid2,hImage);
% 			
...
global eeQ4;
eeQ4 = str2double(get(hObject, 'String'));
end
...
global eeQ3;
eeQ3 = str2double(get(hObject, 'String'));
end
...
global eeQ2;
eeQ2 = str2double(get(hObject, 'String'));
end
...
global eeQ1;
eeQ1 = str2double(get(hObject, 'String'));
end
...
% 	speed = 'v50';
	...
	switch poseMode
		case 1
			...
			eeq3 = eeQ3;
			eeq4 = eeQ4;
	        commandStr = sprintf('moveerc %d %d %d %d %d %d %d %s', eex,eey,eez,eeq1,eeq2,eeq3,eeq4,speed);
	        queue.add(commandStr);
		case 2
			eex = eeX;
			eey = eeY;
			...
			eeq3 = eeQ3;
			eeq4 = eeQ4;
            commandStr = sprintf('moveert %d %d %d %d %d %d %d %s', eex,eey,eez,eeq1,eeq2,eeq3,eeq4,speed);
            queue.add(commandStr);
		case 3
			q1 = jaQ1;
			q2 = jaQ2;
		...
		case 4
			...
			eeq3 = eeQ3;
			eeq4 = eeQ4;
            commandStr = sprintf('moveree %d %d %d %d %s', eeq1,eeq2,eeq3,eeq4,speed);
            queue.add(commandStr);
	end
...
% handles    structure with handles and user data (see GUIDATA)\    REORIENTjogQ4posValue = get(hObject,'Value');
    ...
    if REORIENTjogQ4negValue == 1
		commandStr = sprintf('REORIENTjogQ4negSTART %s',j_Speed);
		queue.add(commandStr);
    else
		commandStr = sprintf('REORIENTjogQ4negEND %s',j_Speed);
		queue.add(commandStr);
    end
end
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if REORIENTjogQ4posValue == 1
		commandStr = sprintf('REORIENTjogQ4posSTART %s',j_Speed);
		queue.add(commandStr);
    else
		commandStr = sprintf('REORIENTjogQ4posEND %s',j_Speed);
		queue.add(commandStr);
    end
end
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if REORIENTjogQ3negValue == 1
		commandStr = sprintf('REORIENTjogQ3negSTART %s',j_Speed);
		queue.add(commandStr);
    else
		commandStr = sprintf('REORIENTjogQ3negEND %s',j_Speed);
		queue.add(commandStr);
    end
end
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if REORIENTjogQ3posValue == 1
		commandStr = sprintf('REORIENTjogQ3posSTART %s',j_Speed);
		queue.add(commandStr);
    else
		commandStr = sprintf('REORIENTjogQ3posEND %s',j_Speed);
		queue.add(commandStr);
    end
end
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if REORIENTjogQ2negValue == 1
		commandStr = sprintf('REORIENTjogQ2negSTART %s',j_Speed);
		queue.add(commandStr);
    else
		commandStr = sprintf('REORIENTjogQ2negEND %s',j_Speed);
		queue.add(commandStr);
    end
end
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if REORIENTjogQ2posValue == 1
		commandStr = sprintf('REORIENTjogQ2posSTART %s',j_Speed);
		queue.add(commandStr);
    else
		commandStr = sprintf('REORIENTjogQ2posEND %s',j_Speed);
		queue.add(commandStr);
    end
end
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if REORIENTjogQ1negValue == 1
		commandStr = sprintf('REORIENTjogQ1negSTART %s',j_Speed);
		queue.add(commandStr);
    else
		commandStr = sprintf('REORIENTjogQ1negEND %s',j_Speed);
		queue.add(commandStr);
    end
end
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if REORIENTjogQ1posValue == 1
		commandStr = sprintf('REORIENTjogQ1posSTART %s',j_Speed);
		queue.add(commandStr);
    else
		commandStr = sprintf('REORIENTjogQ1posEND %s',j_Speed);
		queue.add(commandStr);
    end
end
