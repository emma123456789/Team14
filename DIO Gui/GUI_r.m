...
% Last Modified by GUIDE v2.5 14-Sep-2018 11:03:25
...
[xtab,ytab] = getpts(handles.TableCamera);
[xcon,ycon] = getpts(handles.ConveyorCamera);
global xTab yTab xCon yCon
xTab = xtab;
yTab = ytab;
xCon = xcon;
yCon = ycon;
...
% Hints: get(hObject,'String') returns contents of jointAngleQ6 as text
%        str2double(get(hObject,'String')) returns contents of jointAngleQ6 as a double
global jaQ6
